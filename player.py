...
from constants import PLAYER_RADIUS, PLAYER_SHOOT_COOLDOWNS, PLAYER_SHOT_SPEED, PLAYER_SPEED, PLAYER_TURN_SPEED,SHOT_RADIUS
import pygame
...
class Player(CircleShape):
    ...
    def shoot(self):
        self.__timer = PLAYER_SHOOT_COOLDOWNS
